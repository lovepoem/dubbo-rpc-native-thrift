...
public class ThriftProtocolTest {
    ...
    public void testThriftProtocol() throws TException{
        ...
        URL url = URL.valueOf("native-thrift://127.0.0.1:5342/" + DemoService.Iface.class.getName() + "?version=1.0.0&native-thrift.overload.method=true");
    ...
    public void testGenericInvoke() throws TException{
        ...
        ProxyFactory proxyFactory = ExtensionLoader.getExtensionLoader(ProxyFactory.class).getAdaptiveExtension();
        Protocol protocol = ExtensionLoader.getExtensionLoader(Protocol.class).getAdaptiveExtension();
        URL url = URL.valueOf("native-thrift://127.0.0.1:5342/" + DemoService.Iface.class.getName() + "?version=1.0.0");
        Exporter<DemoService.Iface> exporter = protocol.export(proxyFactory.getInvoker(server, DemoService.Iface.class, url));
    ...
    public void testGenericInvokeWithNativeJava() throws IOException, ClassNotFoundException {
        ...
        ProxyFactory proxyFactory = ExtensionLoader.getExtensionLoader(ProxyFactory.class).getAdaptiveExtension();
        Protocol protocol = ExtensionLoader.getExtensionLoader(Protocol.class).getAdaptiveExtension();
        URL url = URL.valueOf("native-thrift://127.0.0.1:5342/" + DemoService.Iface.class.getName() + "?version=1.0.0&generic=nativejava");
        Exporter<DemoService.Iface> exporter = protocol.export(proxyFactory.getInvoker(server, DemoService.Iface.class, url));
        Invoker<GenericService> invoker = protocol.refer(GenericService.class, url);
        GenericService client = proxyFactory.getProxy(invoker);
    ...
    public void testGenericInvokeWithBean() {
        ...
        ProxyFactory proxyFactory = ExtensionLoader.getExtensionLoader(ProxyFactory.class).getAdaptiveExtension();
        Protocol protocol = ExtensionLoader.getExtensionLoader(Protocol.class).getAdaptiveExtension();
        URL url = URL.valueOf("native-thrift://127.0.0.1:5342/" + DemoService.Iface.class.getName() + "?version=1.0.0&generic=bean");
        Exporter<DemoService.Iface> exporter = protocol.export(proxyFactory.getInvoker(server, DemoService.Iface.class, url));
        Invoker<GenericService> invoker = protocol.refer(GenericService.class, url);
        GenericService client = proxyFactory.getProxy(invoker);
    ...
    public void testOverload() throws TException{
        ...
        ProxyFactory proxyFactory = ExtensionLoader.getExtensionLoader(ProxyFactory.class).getAdaptiveExtension();
        Protocol protocol = ExtensionLoader.getExtensionLoader(Protocol.class).getAdaptiveExtension();
        URL url = URL.valueOf("native-thrift://127.0.0.1:5342/" + DemoService.Iface.class.getName() + "?version=1.0.0&native-thrift.overload.method=true&native-thrift2.request=false");
        Exporter<DemoService.Iface> exporter = protocol.export(proxyFactory.getInvoker(server, DemoService.Iface.class, url));
        Invoker<DemoService.Iface> invoker = protocol.refer(DemoService.Iface.class, url);
        DemoService.Iface client = proxyFactory.getProxy(invoker);
        String result = client.sayHello("haha");
    ...
    public void testHttpClient() throws TException{
        ...
        ProxyFactory proxyFactory = ExtensionLoader.getExtensionLoader(ProxyFactory.class).getAdaptiveExtension();
        Protocol protocol = ExtensionLoader.getExtensionLoader(Protocol.class).getAdaptiveExtension();
        URL url = URL.valueOf("native-thrift://127.0.0.1:5342/" + DemoService.Iface.class.getName() + "?version=1.0.0&client=httpclient&native-thrift.overload.method=true");
        Exporter<DemoService.Iface> exporter = protocol.export(proxyFactory.getInvoker(server, DemoService.Iface.class, url));
        Invoker<DemoService.Iface> invoker = protocol.refer(DemoService.Iface.class, url);
        DemoService.Iface client = proxyFactory.getProxy(invoker);
        String result = client.sayHello("haha");
    ...
    public void testTimeOut() throws TException{
        ...
        ProxyFactory proxyFactory = ExtensionLoader.getExtensionLoader(ProxyFactory.class).getAdaptiveExtension();
        Protocol protocol = ExtensionLoader.getExtensionLoader(Protocol.class).getAdaptiveExtension();
        URL url = URL.valueOf("native-thrift://127.0.0.1:5342/" + DemoService.Iface.class.getName() + "?version=1.0.0&timeout=10");
        Exporter<DemoService.Iface> exporter = protocol.export(proxyFactory.getInvoker(server, DemoService.Iface.class, url));
        Invoker<DemoService.Iface> invoker = protocol.refer(DemoService.Iface.class, url);
        DemoService.Iface client = proxyFactory.getProxy(invoker);
        try {
